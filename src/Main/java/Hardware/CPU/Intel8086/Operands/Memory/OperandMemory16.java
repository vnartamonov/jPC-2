...
public final class OperandMemory16 implements Operand {
    ...
    public int getValue() {
        ...
        return m_cpu.readMEM16(m_segment.getBase(), m_offset.getValue());
    }

    @Override
    public void setValue(int value) {

        m_cpu.writeMEM16(m_segment.getBase(),
                         m_offset.getValue(),
                         value);
    }
    ...
    public String toString() {
        ...
        return String.format("wordptr [%s:%s]", m_segment.toString(), m_offset.toString());
    }
}
