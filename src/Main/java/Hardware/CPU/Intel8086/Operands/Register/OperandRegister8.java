...
public final class OperandRegister8 implements Operand {

    private final Reg8 m_reg8;

    public OperandRegister8(Reg8 reg8) {
    ...
    public int getValue() {
        ...
        return m_reg8.getValue();
    }

    @Override
    public void setValue(int value) {

        m_reg8.setValue(value);
    }

    @Override
    public String toString() {

        return m_reg8.toString();
    }
}
