...
public final class CALL_FAR extends Instruction {
    ...
    public void run() {
        ...
        m_cpu.pushStack(m_cpu.CS.getSelector());
        m_cpu.pushStack(m_cpu.IP.getValue());
    ...
    public String toString() {
        ...
        return String.format("call %s, %s", m_cs.toString(), m_ip.toString());
    }
}