...
public final class CMP8 extends Instruction {

    private final Operand m_destination;
    private final Operand m_source;

    public CMP8(Intel8086 cpu,
                Operand destination,
                Operand source,
                int cycles) {
    ...
    public String toString() {
        ...
        return String.format("cmp %s, %s", m_destination.toString(), m_source.toString());
    }
}
