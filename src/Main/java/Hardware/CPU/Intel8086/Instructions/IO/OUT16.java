...
public final class OUT16 extends Instruction {

    private final Operand m_port;

    public OUT16(Intel8086 cpu,
                 Operand port,
                 int cycles) {
    ...
    public void run() {
        ...
        m_cpu.writeIO16(m_port.getValue(), m_cpu.AX.getValue());
    ...
    public String toString() {
        ...
        return String.format("out %s, ax", m_port.toString());
    }
}
