...
public final class IN8 extends Instruction {

    private final Operand m_port;

    public IN8(Intel8086 cpu,
               Operand port,
               int cycles) {
    ...
    public void run() {
        ...
        m_cpu.AL.setValue(m_cpu.readIO8(m_port.getValue()));
    ...
    public String toString() {
        ...
        return String.format("in al, %s", m_port.toString());
    }
}
