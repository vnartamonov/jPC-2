...
public final class SAR16 extends Instruction {
    
    private final Operand m_destination;
    private final Operand m_count;
    
    public SAR16(Intel8086 cpu,
                 Operand destination,
                 Operand count,
                 int cycles) {
    ...
    public void run() {
        ...
        int dest = signExtend16To32(m_destination.getValue());
        int result = (count >= 16) ? 0xffff : dest >> count;
