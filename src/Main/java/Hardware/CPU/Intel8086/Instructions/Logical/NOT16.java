...
public final class NOT16 extends Instruction {

    private final Operand m_destination;
    
    public NOT16(Intel8086 cpu,
                 Operand destination,
                 int cycles) {
    ...
    public void run() {
        ...
        m_destination.setValue(m_destination.getValue() ^ 0xffff);
    ...
    public String toString() {
        ...
        return String.format("not %s", m_destination.toString());
    }
}
