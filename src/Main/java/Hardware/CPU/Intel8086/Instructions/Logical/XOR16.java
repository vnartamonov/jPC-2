...
public final class XOR16 extends Instruction {

    private final Operand m_destination;
    private final Operand m_source;

    public XOR16(Intel8086 cpu,
                 Operand destination,
                 Operand source,
                 int cycles) {
    ...
    public void run() {
        ...
        int result = m_destination.getValue() ^ m_source.getValue();
    ...
    public String toString() {
        ...
        return String.format("xor %s, %s", m_destination.toString(), m_source.toString());
    }
}
